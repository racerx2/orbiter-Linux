...
class HazeManager : private VulkanEffect 
{
public:
	/**
	 ...
	 */
	HazeManager (const oapi::VulkanClient *gclient, const vPlanet *vplanet);
	...
	void Render (VulkanDevice *dev, FMATRIX4 &wmat, bool dual = false);
...
private:
	...
	static VulkanBuffer *pSkyVB[6];
	static VulkanBuffer *pRingVB;
};
