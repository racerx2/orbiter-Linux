...
void vStar::GlobalInit (oapi::VulkanClient *gc)
{
...
bool vStar::Render(VulkanDevice *dev)
{
	_TRACE;
	...
	//VulkanEffect::RenderBillboard(&mWorld, scn->GetSunTexture(), 1.0f);
	VulkanEffect::RenderBillboard(&mWorld, SURFACE(deftex)->GetTexture(), 1.0f);
	return true;
}
