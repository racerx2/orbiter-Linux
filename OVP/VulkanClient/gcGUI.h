...
public:
	...
	inline bool Initialize()
	{
		...
		// Same substitution as gcGetCoreInterface() in gcCore.h: the reference
		// names the graphics client's own module file, "D3D9Client.dll". Here
		// that module is VulkanClient, spelled without an extension because the
		// Linux GetModuleHandle matches on the lower-cased stem through the
		// loader index orb_LoadLibrary maintains.
