...
void Create()
{
	...
	dwCmd = oapiRegisterCustomCmd((char*)"Vulkan Atmospheric Controls", (char*)"This dialog allows to control various atmospheric parameters and effects", OpenDlgClbk, NULL);
...
void OpenDlgClbk(void *context)
{
	...
	for (auto& s : Slider)
	{
		...
		toolInfo.uFlags = TTF_IDISHWND | TTF_SUBCLASS;
		toolInfo.uId = (UINT_PTR)s.hWnd;	
		toolInfo.lpszText = (LPSTR)"ToolTip";
