...
bool XRSoundConfigFileParser::ParseLine(const char *pSection, const char *pPropertyName, const char *pValue, const bool bParsingOverrideFile)
{
    ...
    else if(SECTION_MATCHES("SOUND_FILES"))
    {
        ...
        else PARSE_STRING_PROPERTY(RCSClosePlusX)
        else PARSE_STRING_PROPERTY(RCSClosePlusY)
        else PARSE_STRING_PROPERTY(RCSClosePlusZ)
        else PARSE_STRING_PROPERTY(RCSCloseMinusX)
        else PARSE_STRING_PROPERTY(RCSCloseMinusY)
        else PARSE_STRING_PROPERTY(RCSCloseMinusZ)
